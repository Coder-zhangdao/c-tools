...
// Source File Name:   SybaseASE.java
...
public class SybaseASE extends DBType {
    ...
    static {
        ...
        m_allDataTypes = (new DataType[]{
                BINARY, BIT, CHAR, DATETIME, DECIMAL, FLOAT, IMAGE, INT, MONEY, NCHAR,
                NUMERIC, NVARCHAR, REAL, SMALLDATETIME, SMALLINT, SMALLMONEY, TEXT, TIMESTAMP, TINYINT, VARBINARY,
                VARCHAR
        });
        m_supportedDataTypes = (new DataType[]{
                SMALLINT, TINYINT, INT, NUMERIC, NVARCHAR, DATETIME, FLOAT, NUMERIC
        });
    }
