...
public interface Interceptor {
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	boolean onLoad(Object entity, Serializable id, Object[] state, String[] propertyNames) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	boolean onFlushDirty(Object entity, Serializable id, Object[] currentState, Object[] previousState, String[] propertyNames) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	boolean onSave(Object entity, Serializable id, Object[] state, String[] propertyNames) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	void onDelete(Object entity, Serializable id, Object[] state, String[] propertyNames) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	void onCollectionRecreate(Object collection, Serializable key) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	void onCollectionRemove(Object collection, Serializable key) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	void onCollectionUpdate(Object collection, Serializable key) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	void preFlush(Iterator<?> entities) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	void postFlush(Iterator<?> entities) throws SQLException;
	 ...
	 */
	int[] findDirty(Object entity, Serializable id, Object[] currentState, Object[] previousState, String[] propertyNames);
	/**
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	Object instantiate(String entityName,Serializable id) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	String getEntityName(Object object) throws SQLException;
     ...
     * @throws java.sql.SQLException Thrown if the interceptor encounters any problems handling the callback.
     */
	Object getEntity(String entityName, Serializable id) throws SQLException;
