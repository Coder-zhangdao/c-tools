...
public class SimpleHttpServletResponse implements HttpServletResponse {
    ...
    private final Map<String, SimpleHttpServletRequest.HeaderValueHolder> headers = new LinkedCaseInsensitiveMap<>();
    ...
    public boolean containsHeader(String name) {
        return (SimpleHttpServletRequest.HeaderValueHolder.getByName(this.headers, name) != null);
    }
    ...
    public String getHeader(String name) {
        SimpleHttpServletRequest.HeaderValueHolder header = SimpleHttpServletRequest.HeaderValueHolder.getByName(this.headers, name);
    ...
    private void doAddHeaderValue(String name, Object value, boolean replace) {
        ...
        if (header == null) {
            header = new SimpleHttpServletRequest.HeaderValueHolder();
